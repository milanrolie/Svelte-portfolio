<section class="about">
  ...
  <p>
    ...
    always find avenues to channel my creativity and bring unique concepts to
    life. 
    <br> <br>
    My drive and enthusiasm push me to constantly seek new challenges and
...
<style>
    .line{
        border-top: solid 1px var(--webLavender);
        margin-bottom: 5em;
    }
